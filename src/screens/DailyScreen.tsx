        ...
        <ScreenTransition className="flex flex-col h-full bg-[var(--surface-bg)] px-6 pb-20">
            <div className="flex flex-col h-full gap-6 relative overflow-hidden">
                ...
                <header className="flex items-center gap-4 pt-2 z-10">
                    ...
                    <h1 className="text-2xl font-black bg-gradient-to-r from-fuchsia-400 to-orange-400 text-transparent bg-clip-text">Günlük Görev</h1>
                </header>
                ...
                >
                    ...
                    <div className="flex flex-col items-center text-center">
                        ...
                        <h2 className="text-3xl font-black text-white">Günün Bulmacası</h2>
                        <p className="text-sm text-indigo-300 font-medium mt-2 tracking-wide uppercase">
                            {todayObj.toLocaleDateString('tr-TR', { weekday: 'long', day: 'numeric', month: 'long' })}
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4 w-full">
                        <div className="glass rounded-2xl p-4 flex flex-col items-center justify-center border border-white/5">
                            ...
                            <span className="text-xs text-slate-400 font-medium uppercase tracking-wider">Günlük Seri</span>
                        </div>

                        <div className="glass rounded-2xl p-4 flex flex-col items-center justify-center border border-white/5">
                            <span className="text-3xl mb-1">⏳</span>
                            <span className="text-xl font-mono font-bold text-orange-400">{timeLeft}</span>
                            <span className="text-xs text-slate-400 font-medium uppercase tracking-wider">Yenilenme</span>
                        </div>
                    </div>
                    ...
                    {isCompletedToday ? (
                        ...
                        <button
                            className="w-full py-5 rounded-2xl bg-gradient-to-r from-fuchsia-500 to-orange-500 text-white font-black text-xl shadow-[0_0_30px_rgba(217,70,239,0.3)] hover:scale-[1.02] active:scale-95 transition-all"
                ...
                <p className="text-center text-xs text-slate-500 mt-auto px-4 z-10 font-medium">
                    Günlük bulmaca internet saatine (WorldTimeAPI) duyarlıdır, hile yapılamaz.
                </p>
            </div>
        </ScreenTransition>
    )
