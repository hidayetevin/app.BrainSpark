...
export function SudokuGrid() {
    ...
    return (
        <div className="flex justify-center items-center w-full max-w-md mx-auto aspect-square p-2">
            <div
                className="w-full h-full grid grid-cols-9 bg-white dark:bg-[#1e293b] rounded-xl overflow-hidden shadow-xl"
